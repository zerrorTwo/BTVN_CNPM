...
const productsByCategory: { [key: string]: any[] } = {
  ...
  "Home & Kitchen": [
    ...
    },
    {
      ...
      brand: "ToastPro",
      stock: 42,
      description: "Countertop toaster oven with convection",
    },
    {
      name: "Stand Mixer",
      price: 299.99,
    ...
    },
    {
      ...
      brand: "KitchenOrg",
      stock: 65,
      description: "Rust-proof dish drying rack",
    },
  ],
  "Sports & Outdoors": [
    {
    ...
    },
    {
      ...
      brand: "CookOutdoor",
      stock: 50,
      description: "Compact camping stove with fuel canister",
    },
    {
  ...
  "Books & Media": [
    {
      name: "Best Seller Fiction Novel",
      price: 24.99,
      brand: "ReadWell",
      stock: 100,
    ...
    },
    {
      ...
      brand: "ChefGuide",
      stock: 75,
      description: "Comprehensive cooking guide with recipes",
    },
    {
    ...
    {
      name: "Photography Tutorial DVD",
      price: 29.99,
      brand: "LearnPhoto",
      stock: 45,
      description: "Complete photography course on DVD",
    },
    {
      name: "Fitness Training eBook",
      price: 19.99,
      brand: "FitGuide",
      stock: 200,
      description: "Digital fitness and nutrition guide",
    },
    {
      ...
      brand: "ClassicSound",
      stock: 55,
      description: "Box set of classical music CDs",
    },
    {
      ...
      brand: "WorldViews",
      stock: 40,
      description: "Stunning travel photography collection",
    },
    {
    ...
    },
    {
      ...
      brand: "CodeMaster",
      stock: 80,
      description: "Comprehensive programming textbook",
    },
    {
      ...
      brand: "RetroSound",
      stock: 22,
      description: "Vintage-style vinyl record player",
    },
  ],
};
  ...
  try {
    ...
    for (let i = 0; i < usernames.length; i++) {
      const user = await User.create({
        ...
        firstName: usernames[i].charAt(0).toUpperCase() + usernames[i].slice(1),
        lastName: "User",
      });
      users.push(user);
    }
    ...
    console.log(
      `✅ Created ${totalOrders} orders with ${totalOrderItems} items`
    );
    ...
    console.log(`✅ Created ${totalViews} product views`);
    ...
    console.log(`   - Product Views: ${totalViews}`);
